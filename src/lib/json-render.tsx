  ...
  return {
    ...
    elements: {
      ...
      'stack-main': {
        ...
        children: ['summary-heading', 'summary-text', 'meta-table', 'sep-1', 'bull-heading', 'bull-table', 'bear-heading', 'bear-table'],
      },
      'summary-heading': {
        type: 'Heading',
        props: { text: `${recData?.signal ?? 'HOLD'} · ${recData?.confidence ?? 0}% confidence`, level: 'h3' },
      },
      'summary-text': {
        type: 'Text',
      ...
      'bull-table': { type: 'Table', props: { columns: ['Item'], rows: bullishRows.length ? bullishRows : [['—']] } },
      'bear-heading': { type: 'Heading', props: { text: 'Bearish factors', level: 'h4' } },
      'bear-table': { type: 'Table', props: { columns: ['Item'], rows: bearishRows.length ? bearishRows : [['—']] } },
    },
  }
}
